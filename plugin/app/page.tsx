...
export default function AgeVerificationPage() {
  ...
  const renderSelectedMethod = () => {
    switch (selectedMethod) {
      case 'facescan':
        return <FaceScanStep onBack={handleBack} />
      case 'bankid':
        return <BankIDStep onBack={handleBack} />
      case 'mojeid':
        return <MojeIDStep onBack={handleBack} />
      case 'ocr':
        return <IDScanStep onBack={handleBack} />
      case 'revalidate':
        return <RepeatedVerificationStep onBack={handleBack} />
      case 'other_device':
        return <OtherDeviceStep onBack={handleBack} />
      default:
        return null
    }
  }
